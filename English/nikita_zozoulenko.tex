...
The code and the trained models from this following section are publically available in the github repository \textit{nikitazozoulenko/FCC-vs-CNN-mnist}.
...
The implementation and code is publicly available in the github repository \textit{nikitazozoulenko/time-series-CNN}
\subsection{Background}
